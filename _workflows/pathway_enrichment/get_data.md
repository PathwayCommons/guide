...
This section provides detailed instructions on sourcing raw gene expression *data* and *metadata* (Box 1) suitable for downstream differential expression analysis (Figure 1). Though the focus here is on obtaining gene expression data the methods can be easily adapted to other types. By then end of this discussion you should:
