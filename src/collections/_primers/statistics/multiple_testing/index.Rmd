...
blurb: Deep-dive into the basis of multiple testing errors and popular correction methods
...
![image]({{ page.figures.table_1 }}){: .narrow }
...
![image]({{ page.figures.figure_3 }}){: .narrow }
...
![image]({{ page.figures.table_2 }}){: .narrow }
...
{: .card .bg-light }
  - {: .card-title .list-unstyled } ### Asides
