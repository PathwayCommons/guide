...
Miller *et al.* (Miller 2017) couple functional screening with enrichment analysis to uncover genes involved in transcriptional pause release as a mechanism that underlies the growth advantage of GBM *in vivo*.
