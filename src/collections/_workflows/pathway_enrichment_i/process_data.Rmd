...
tcgaov_dge <- readRDS(file.path(base_dir, "data", "tcgaov_dge.rds"))
...
```{r results="asis"}
  pandoc.table(head(tcgaov_dge$samples, n=4)[,c('group', 'lib.size', 'norm.factors')],
 style = "rmarkdown",
 split.table = Inf)
```
...
```{r, echo=TRUE, out.width = 400, fig.align="center"}
### ============ Plotting ===============
###  Plotting BCV
