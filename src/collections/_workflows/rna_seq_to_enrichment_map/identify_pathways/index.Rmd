...
We have renamed the enrichment report files and provide them below.
  ...
  <a href="{{ page.data.report_brca }}" role="button" class="btn btn-secondary btn-lg btn-block" download>BrCa report (.xls)</a>

  2. Enrichment report for HD
  <a href="{{ page.data.report_hd }}" role="button" class="btn btn-secondary btn-lg btn-block" download>HD report (.xls)</a>
